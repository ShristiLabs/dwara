...
use support::{
    dataplane_from, envelope_code, h1_client, spawn_backend, spawn_gateway, state_from, uri,
};
...
fn two_endpoint_gateway_yaml(
    ...
    support::gateway_yaml(gateway_extra, backend_port, backend_port2, upstream_extra)
}
